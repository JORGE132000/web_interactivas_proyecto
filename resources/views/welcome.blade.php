            ...
            <div id="carouselExampleCaptions" class="carousel carousel-dark slide" data-bs-ride="carousel">
                ...
                <div class="carousel-inner">
                    <div class="carousel-item active">
                        <img src="{{ URL('images/pexels-1.jpg') }}" height="700px" class="d-block w-100" alt="...">
                    ...
                    <div class="carousel-item">
                        <img src="{{ URL('images/pexels-2.jpg') }}" height="700px"class="d-block w-100" alt="...">
                        <div class="carousel-caption d-none d-md-block">
                        <h5>Más anillos</h5>
                    ...
                    <div class="carousel-item">
                        <img src="{{ URL('images/pexels-3.jpg') }}" height="700px" class="d-block w-100" alt="...">
                        <div class="carousel-caption d-none d-md-block">
