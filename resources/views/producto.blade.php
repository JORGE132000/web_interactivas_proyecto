    ...
    <body class="antialiased">
            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                        <li class="nav-item">
                            <a class="nav-link active" aria-current="page" href="#">Collares</a>
                        </li>
                        <li class="nav-item">
        ...
        <div class="container pt-4">
            <div class="row">
                <div class="col">
                    <div>
                        <img src="{{ asset('images/' . $articulo->image_path) }}" width="350" alt="Producto Collar" class="img-thumbnail ms-5">
                    </div>
                </div>
                <div class="col">
                    <div>
                        <h1><strong>{{$articulo->articulo}}</strong></h1>
                        <br>
                        <h2><strong>Precio: </strong>${{$articulo->precio}}</h2>
                        <br>
        ...
        <h1><strong>Artículos Recomendados</strong></h1>
            <div class="row pb-5">
                @foreach($articulos as $articulo)
                <div class="col">
                    <div class="card p-3 mb-4" style="width: 18rem;">
                        <img src="{{ asset('images/' . $articulo->image_path) }}" class="card-img-top img-thumbnail cssCenterImage" alt="...">
                        <div class="card-body">
